...
const cards = [
  ...
  { to: '/ai-data', zone: 'mgmt', title: 'AI & Data', body: 'Five pages: local models, the data lake, agents, MCP, and the stores underneath. Nothing leaves the house to be processed.', meta: 'models · data lake · agents · mcp · stores' },
